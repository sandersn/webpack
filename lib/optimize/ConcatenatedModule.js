...
class ConcatenatedModule extends Module {
    ...
    /** @typedef {{
        ...
        exportMap: Map,
        reexportMap: Map,
        hasNamespaceObject: boolean,
        namespaceObjectSource: any
    }} Concatenated */
    /** @typedef {{
        type: "external",
        module: any,
        ...
        interopNamespaceObjectName: any,
        interopDefaultAccessUsed: boolean,
        interopDefaultAccessName: any
        }} External */
    /** @typedef {External | Concatenated} Module */
	source(dependencyTemplates, runtimeTemplate) {
		...
		for (const info of modulesWithInfo) {
			...
			if (info.type === "concatenated" && info.moduleScope) {
			...
			// add global symbols
			if (info.type === "concatenated" && info.globalScope) {
